# Training script on CUDA 1 and for seed 1
...
# YOLOv4
cd ~/PycharmProjects/DCW/YOLOv4;  /home/dong9/anaconda3/envs/cottonweeddetection/bin/python  train.py --device 1 --batch-size 16 --img 640 640 --epochs 5 --data cottonweedsdetection_seed1.yaml --cfg cfg/yolov4.cfg --weights 'yolov4.pt' --name yolov4
cd ~/PycharmProjects/DCW/YOLOv4;  /home/dong9/anaconda3/envs/cottonweeddetection/bin/python  train.py --device 1 --batch-size 16 --img 640 640 --epochs 5 --data cottonweedsdetection_seed1.yaml --cfg cfg/yolov4-csp-leaky.cfg --weights 'yolov4-csp-leaky.pt' --name yolov4-pacsp-leaky
...
cd ~/PycharmProjects/DCW/YOLOR;  /home/dong9/anaconda3/envs/cottonweeddetection/bin/python  train.py --batch-size 16 --device 1  --img 640 640 --epochs 5 --data cottonweedsdetection_seed1.yaml --cfg cfg/yolor_csp_x.cfg --weights 'yolor_csp_x.pt' --name yolor_csp_x --hyp hyp.scratch.640.yaml
cd ~/PycharmProjects/DCW/YOLOR;  /home/dong9/anaconda3/envs/cottonweeddetection/bin/python  train.py --batch-size 16 --device 1  --img 640 640 --epochs 5 --data cottonweedsdetection_seed1.yaml --cfg cfg/yolor_p6.cfg --weights 'yolor_p6.pt' --name yolor_p6 --hyp hyp.scratch.640.yaml
cd ~/PycharmProjects/DCW/YOLOR;  /home/dong9/anaconda3/envs/cottonweeddetection/bin/python  train.py --batch-size 16 --device 1  --img 640 640 --epochs 5 --data cottonweedsdetection_seed1.yaml --cfg cfg/yolor_w6.cfg --weights 'yolor-w6.pt' --name yolor_w6 --hyp hyp.scratch.640.yaml
