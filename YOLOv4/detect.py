...
def detect(save_img=False):
    ...
    if os.path.exists(out):
        shutil.rmtree(out)  # delete yolov4 folder
    os.makedirs(out)  # make new yolov4 folder
            ...
            if save_img:
                if dataset.mode == 'images':
                    ...
                    if vid_path != save_path:  # new video
                        ...
                        fourcc = 'mp4v'  # yolov4 video codec
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', type=str, default='inference/output', help='output folder')  # yolov4 folder
