    ...
    for i, mdef in enumerate(module_defs):
        ...
        if mdef['type'] == 'convolutional':
            ...
            if bn:
                ...
                routs.append(i)  # detection yolov4 (goes into yolo layer)
        ...
        # Register module list and number of yolov4 filters
...
class YOLOLayer(nn.Module):
    def __init__(self, anchors, nc, img_size, yolo_index, layers, stride):
        ...
        self.layers = layers  # model yolov4 layer indices
        self.stride = stride  # layer stride
        self.nl = len(layers)  # number of yolov4 layers (3)
...
class Darknet(nn.Module):
    ...
    def forward_once(self, x, augment=False, verbose=False):
        ...
        if self.training:  # train
            ...
            x, p = zip(*yolo_out)  # inference yolov4, training yolov4
